      ...
      <v-layout row justify-space-between>
        ...
        <v-flex xs8>
          <v-layout row justify-space-around wrap>
            <v-flex xs12 class="goal-item" v-for="(hero,i) in heros" :key="i">
              <v-card>
                ...
                <v-card-text>
                  <v-layout wrap>
                    ...
                    <v-flex xs10>
                     <strong> <p class="font-size-18 color-special">{{hero.nominated_user.first_name}}</p></strong>
                      <p class="font-size-18">Won {{hero.points}} Points</p>     
                      <p class="font-size-18">Nominated by {{hero.nominated_by.name}} </p>     
                    </v-flex>
                    <v-flex xs12>
                      <img class="type-logo" :src="hero.logo" alt="John">

                      <img src="@/assets/images/Cover.svg" alt="John">
                      <v-layout wrap>
                        <v-flex xs6>
                          <p class="fancy">{{hero.Type}}
                      </p>
                        </v-flex>
                        <v-flex xs6>
                          <p class="fancy">
                        {{hero.nomination_id.name}}
                      </p>
                        </v-flex>
                      </v-layout>
                    </v-flex>
                    <v-flex xs12>
                      <v-alert
                        ...
                        icon="check_circle"
                        outline
                      >congratulations {{hero.nominated_user.first_name}}!</v-alert>
                    </v-flex>
                    <!-- <v-flex xs2>
                      <v-btn color="pink" style="color:white; margin-top:10px">
